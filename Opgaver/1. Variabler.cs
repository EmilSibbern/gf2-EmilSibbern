namespace Opgaver
{
    public class Variabler
    {
        ...
        public static void Bool1()
        {
            ...
            bool trueFalseBool = false;

            Console.WriteLine(trueFalseBool.ToString());
        }
        ...
        public static void Float1()
        {
            ...
            // Lav opgaven herunder!
            float floatPi = 3;
            Console.WriteLine(floatPi + 0.14);
        }
